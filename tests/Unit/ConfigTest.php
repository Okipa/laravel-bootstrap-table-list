...
class ConfigTest extends TableListTestCase
{
    public function testConfigStructure()
    {
        ...
        $this->assertTrue(array_key_exists('rows-number-selector',
        ...
        $this->assertTrue(array_key_exists('item',
            config('tablelist.template.table.thead.options-bar.rows-number-selector')));
        $this->assertTrue(array_key_exists('lines',
            config('tablelist.template.table.thead.options-bar.rows-number-selector')));
        $this->assertTrue(array_key_exists('validate',
            config('tablelist.template.table.thead.options-bar.rows-number-selector')));
        // tablelist.template.table.thead.options-bar.rows-number-selector.item
        $this->assertTrue(array_key_exists('class',
        ...
        $this->assertTrue(array_key_exists('container',
        ...
        $this->assertTrue(array_key_exists('trigger-bootstrap-modal',
        ...
        $this->assertTrue(array_key_exists('with-create-route',
            config('tablelist.template.table.tfoot.options-bar.navigation')));
        $this->assertTrue(array_key_exists('without-create-route',
            config('tablelist.template.table.tfoot.options-bar.navigation')));
